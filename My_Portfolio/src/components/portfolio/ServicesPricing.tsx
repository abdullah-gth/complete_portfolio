      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingData.packages?.map((pkg: any) => (
            <div
              key={pkg.id}
              className={`relative flex flex-col p-8 rounded-3xl transition-all duration-300 bg-background border overflow-hidden group ${
                pkg.highlighted 
                  ? "border-primary shadow-xl md:-translate-y-4 hover:-translate-y-6" 
                  : "border-border shadow-md hover:shadow-xl hover:border-primary/50 hover:-translate-y-2"
              }`}
            >
              ...
              <div className="mb-6 relative z-10">
                <h3 className="text-2xl font-bold mb-2 group-hover:text-primary transition-colors">{pkg.title}</h3>
              ...
              <a
                ...
                className={`w-full py-3.5 px-6 rounded-xl font-semibold text-center transition-all duration-300 relative z-10 ${
                  pkg.highlighted
                    ...
                    : "bg-secondary text-secondary-foreground hover:bg-primary hover:text-primary-foreground hover:shadow-lg"
                }`}
              >
                {pkg.cta_text}
              </a>
